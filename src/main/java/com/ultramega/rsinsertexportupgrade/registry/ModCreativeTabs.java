...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> TAB_RSINSERTEXPORTUPGRADE = TABS.register(RSInsertExportUpgrade.MOD_ID, () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + RSInsertExportUpgrade.MOD_ID)).icon(() -> new ItemStack(ModItems.INSERT_UPGRADE.get())).displayItems((featureFlags, output) -> {
